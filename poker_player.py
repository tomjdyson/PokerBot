import numpy as np
from PokerBot.player_bet import SimpleBet, SimpleModelBet, SimpleNNBet
import pandas as pd
...
class PokerPlayer:
    def __init__(self, name, bet_style='simple', action_clf=None, bet_clf=None):
        ...
        if bet_style == 'simple':
            ...
            self.betting_obj = SimpleNNBet(10)
    ...
    def decide_action(self, game_state, big_blind, curr_max_bet, curr_table, remaining_player_hands,
        ...
        try:
            ...
            # stat_array = state_df[state_df[:, -2] == self.curr_state, -2:].toarray()[0]
            # risk = stat_array[1]/stat_array[0]
